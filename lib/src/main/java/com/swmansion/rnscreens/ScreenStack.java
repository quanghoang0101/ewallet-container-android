      ...
      if (shouldUseOpenAnimation) {
        ...
        switch (stackAnimation) {
          case SLIDE_FROM_RIGHT:
            getOrCreateTransaction()
                .setCustomAnimations(com.walmartlabs.ern.container.R.anim.rns_slide_in_from_right, com.walmartlabs.ern.container.R.anim.rns_slide_out_to_left);
            break;
          case SLIDE_FROM_LEFT:
            getOrCreateTransaction()
                .setCustomAnimations(com.walmartlabs.ern.container.R.anim.rns_slide_in_from_left, com.walmartlabs.ern.container.R.anim.rns_slide_out_to_right);
            break;
          case SLIDE_FROM_BOTTOM:
            getOrCreateTransaction()
                .setCustomAnimations(
                    com.walmartlabs.ern.container.R.anim.rns_slide_in_from_bottom, com.walmartlabs.ern.container.R.anim.rns_no_animation_medium);
            break;
          case FADE_FROM_BOTTOM:
            getOrCreateTransaction()
                .setCustomAnimations(com.walmartlabs.ern.container.R.anim.rns_fade_from_bottom, com.walmartlabs.ern.container.R.anim.rns_no_animation_350);
            break;
        }
      } else {
        ...
        switch (stackAnimation) {
          ...
          case SLIDE_FROM_BOTTOM:
            getOrCreateTransaction()
                .setCustomAnimations(
                    com.walmartlabs.ern.container.R.anim.rns_no_animation_medium, com.walmartlabs.ern.container.R.anim.rns_slide_out_to_bottom);
            break;
          case FADE_FROM_BOTTOM:
            getOrCreateTransaction()
                .setCustomAnimations(com.walmartlabs.ern.container.R.anim.rns_no_animation_250, com.walmartlabs.ern.container.R.anim.rns_fade_to_bottom);
            break;
        }
      }
    }
